      ...
      <section className="mx-auto max-w-7xl">
        <div className="mb-7 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl">กล่องข้อความ VIP</h1>
            <p className="mt-2 text-sm text-muted">ตอบลูกค้า ตรวจรูปที่แนบ และอัปเดตสถานะเคสจากที่เดียว</p>
          </div>
