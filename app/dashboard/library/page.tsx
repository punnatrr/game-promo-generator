...
export default function LibraryPage() {
  ...
  return <main className="min-h-screen bg-[#08080e] px-5 py-9 text-white sm:px-8">
    <div className="mx-auto max-w-6xl">
      <nav aria-label="เส้นทางหน้า" className="mb-9 flex gap-3 text-sm text-white/55"><Link href="/dashboard" className="hover:text-white">บัญชีของฉัน</Link><span>/</span><span className="text-purple-200">คลังงาน</span><Link href="/dashboard/motion" className="ml-auto text-purple-200">สร้างวิดีโอ →</Link></nav>
      <header className="mb-8 flex flex-wrap items-end justify-between gap-5"><div><p className="mb-3 text-xs font-bold tracking-[0.2em] text-purple-300">LAZY-AI.GAME / LIBRARY</p><h1 className="text-3xl font-black sm:text-4xl">เก็บไว้ พร้อมใช้ในงานถัดไป</h1><p className="mt-3 text-sm leading-7 text-white/55">รวมภาพและคลิปของร้าน จัดเป็นชุดงาน แล้วกลับมาใช้ต่อได้</p></div><Link href="/dashboard/brand" className="rounded-xl border border-white/15 px-4 py-3 text-sm text-white/70">ข้อมูลแบรนด์ →</Link></header>
