-- Baseline for databases created through the migration runner.
-- Every statement is idempotent so databases initialized from db/schema.sql
-- can safely adopt the migration ledger.
...
insert into plans (
  ...
  ('basic', 'Basic', '15 รูปต่อเดือน สำหรับเริ่มใช้งาน', 199, 15, false, false, 30, 5, true, 10),
  ('pro', 'Pro', '30 รูปต่อเดือน พร้อมฟีเจอร์พิเศษ', 499, 30, true, false, 30, 5, true, 20),
  ('business', 'Business', '100 รูปต่อเดือน พร้อมฟีเจอร์พิเศษและบริการ VIP', 999, 100, true, true, 30, 5, true, 30)
